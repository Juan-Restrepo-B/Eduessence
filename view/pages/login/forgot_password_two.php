...
<head>
    ...
    <link rel="stylesheet" href="view/css/login/styles_forgot_password.css">
        ...
        <div class="container">
            <div class="containerF">
                <div class="form-container">
                    ...
                    <form action="../../../model/login/forgot_password_two.php" method="POST" id="forgotPasswordForm">
                        <input type="password" name="password" placeholder="Nueva Contraseña" required>
                        <input type="password" name="passwordconfirm" placeholder="Confirmar Contraseña" required>
                        <?php if ($error_message): ?>
                            <span class="error-message" style="color: <?= $color; ?>;">
                                <?= $error_message; ?>
                            </span>
                        <?php endif; ?>
                        <br>
                        <button id="btn" class="btn">RESTAURAR</button>
                    </form>
                </div>
            </div>
        </div>
