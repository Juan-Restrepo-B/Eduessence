<?php
// view/pages/login/login.php

include_once '../../../model/global/sesion_start.php';
include_once '../../../model/global/clear_cache.php';
include_once '../../../model/global/add_ip.php';
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="48x48" href="view/img/logo1.png">
    <link rel="stylesheet" href="view/css/login/styles_login.css">
        ...
        <section class="registerCont">
            <div class="container" id="container">
                ...
                <div class="form-container sign-in-container">
                    <form action="model/login/register_process.php" method="POST">
                        <img src="view/img/logo.png" alt="">
                        <h1>CREAR CUENTA</h1>
                    ...
                    <br>
                    <button class="btn-cuenta oc" id="iniciarCuenta">INICIAR SESION</button>
                </div>
            </div>
        </section>
    </main>
...
<script src="view/js/login/login_logic.js"></script>

<script src="view/js/global/redirect.js"></script>
<script src="view/js/global/dropdown_menu.js"></script>
<script defer src="view/js/global/screen_lock.js"></script>

<script>
    document.addEventListener("DOMContentLoaded", function () {
        const btnNewCuenta = document.getElementById("iniciarCuenta");
